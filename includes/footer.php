...
$footerSocialFacebook  = get_setting($footerDb, 'social_facebook');
$footerSocialInstagram = get_setting($footerDb, 'social_instagram');
...
<footer class="footer" id="contact">
    <div class="container footer-grid">
        ...
        <div class="footer-social">
            <h4><?= $currentLang === 'fr' ? 'Suivez-nous' : 'Siga-nos' ?></h4>
            <div class="social-links">
                <?php if ($footerSocialFacebook): ?>
                <a href="<?= sanitize($footerSocialFacebook) ?>" target="_blank" rel="noopener noreferrer" class="social-link" title="Facebook">
                ...
                <a href="<?= sanitize($footerSocialInstagram) ?>" target="_blank" rel="noopener noreferrer" class="social-link" title="Instagram">
                ...
                <a href="<?= sanitize($footerSocialLinkedin) ?>" target="_blank" rel="noopener noreferrer" class="social-link" title="LinkedIn">
                ...
                <a href="<?= sanitize($footerSocialTwitter) ?>" target="_blank" rel="noopener noreferrer" class="social-link" title="X (Twitter)">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932L18.901 1.153ZM17.61 20.644h2.039L6.486 3.24H4.298L17.61 20.644Z"/></svg>
                </a>
                <?php endif; ?>
                <?php if ($footerSocialYoutube): ?>
                <a href="<?= sanitize($footerSocialYoutube) ?>" target="_blank" rel="noopener noreferrer" class="social-link" title="YouTube">
